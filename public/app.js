...
currentWeightInput.addEventListener('keydown', e => { if (e.key === 'Enter') nextStep4Btn.click(); });
...
targetWeightInput.addEventListener('keydown', e => { if (e.key === 'Enter') nextStep5Btn.click(); });
